-injars art.jar
-injars ../../\mysql-connector-java-3.0.16-ga-bin.jar
#-injars ../../\mysql-connector-java-5.0.0-beta-bin.jar
#-injars ../../\mysql-connector-java-3.1.12-bin.jar
-injars C:/\Program Files/\Java/\jdk1.5.0_06/\jre/\lib/\ext/\jai_core.jar
-outjars art_shrunk.jar
...
-libraryjars 'C:\Program Files\Java\jre1.5.0_06\lib'
...
-keep class com.mysql.jdbc.SocketFactory {
    java.lang.Object newInstance();
}

# For connector 3.1
#-keep class com.mysql.jdbc.jdbc2.optional.MysqlDataSource {
#    java.lang.Object newInstance();
#}
#
#-keep class com.mysql.jdbc.ConnectionPropertiesTransform {
#    java.lang.Object newInstance();
#}
