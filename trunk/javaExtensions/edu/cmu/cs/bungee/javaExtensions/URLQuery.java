 ...
 *
 * @param query1 the URL query part (after the ? character).
 */
 ...
 *
 * @param key the argument key to get the value of.
 * @return the value of the specified URL query key argument value.
 */
 ...
 *
 * @param URL the URL to extract arguments from.
